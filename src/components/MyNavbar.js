...
function MyNavbar(props) {
    ...
    <div className="navbarMainDiv">
        ...
        <div className="navbarRightDiv">
            ...
            <Link to="/databasedesign" className={props.activePage==="databasedesign"?"navbarLink navbarLinkActive":"navbarLink"} onClick={()=>{props.handleActivePage("databasedesign")}}>Database Design</Link>
